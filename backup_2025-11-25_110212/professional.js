...
function generateNamePreview() {
    ...
    setTimeout(() => {
        ...
        // 사주 분석 요약 표시
        document.getElementById('namingPreviewSummary').textContent = result.sajuSummary;
        ...
        // 미리보기 결과 표시
        document.getElementById('namingPreview').classList.remove('hidden');
        document.getElementById('namingPreview').scrollIntoView({ behavior: 'smooth' });
    }, 2000);
}
...
function generateNameFull() {
    ...
    setTimeout(() => {
        ...
        // 사주 분석 상세 표시
        document.getElementById('namingSummary').textContent = result.sajuSummary;
        ...
        // 미리보기 숨기고 전체 결과 표시
        document.getElementById('namingPreview').classList.add('hidden');
        document.getElementById('namingResult').classList.remove('hidden');
        document.getElementById('namingResult').scrollIntoView({ behavior: 'smooth' });
    }, 2500);
}
